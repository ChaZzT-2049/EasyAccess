...
@section('content')
<div class="container">
  <h1 class="text-center">Otros Usuarios</h1>
  <div class="container">
        ...
        <tbody>
          @foreach($users as $user)
            <tr>
              ...
              <td data-titulo="Tipo">{{$user->tipoaux}}</td>
              <td data-titulo="Acciones">
                <a href="{{ url('/editotro', $user->id) }}" class="btn btn-info text-white"><span class="">Editar</span></a>
