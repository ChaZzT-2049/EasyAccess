        ...
        <tbody>
          @foreach($users as $user)
            <tr>
              ...
              <td data-titulo="Numero Empleado">{{$user->numemp}}</td>
              <td data-titulo="Area">{{$user->areaper}}</td>
              <td data-titulo="Editar">
                <a href="{{ url('/editper', $user->id) }}" class="btn btn-info text-white"><i class="icon ion-md-create mr-2 lead"></i></a>
              </td>
