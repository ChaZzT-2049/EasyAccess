        ...
        <tbody>
          @foreach($users as $user)
            <tr>
              ...
              <td data-titulo="Empresa">{{$user->empresaser}}</td>
              <td data-titulo="Encargado">{{$user->encargadoser}}</td>
              <td data-titulo="Area">{{$user->areaser}}</td>
              <td data-titulo="Servicio">{{$user->servicio}}</td>
              <td data-titulo="Acciones">
                <a href="{{ url('/editser', $user->id) }}" class="btn btn-info text-white"><span class="">Editar</span></a>
