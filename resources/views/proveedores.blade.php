        ...
        <tbody>
          @foreach($users as $user)
            <tr>
              ...
              <td data-titulo="Empresa">{{$user->empresapro}}</td>
              <td data-titulo="Encargado">{{$user->encargadopro}}</td>
              <td data-titulo="Descripcion">{{$user->descripcion}}</td>
              <td data-titulo="Acciones">
                <a href="{{ url('/editpro', $user->id) }}" class="btn btn-info text-white"><span class="">Editar</span></a>
